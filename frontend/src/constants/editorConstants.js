...
// Limit how many CSV rows can be previewed in-browser at once to avoid
// excessive memory/network usage. Larger batches should be generated as ZIPs.
export const MAX_PREVIEW_CERTIFICATES = 200;
