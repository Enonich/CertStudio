import { PROJECT_HANDLE_DB_NAME, PROJECT_HANDLE_STORE_NAME, PROJECT_HANDLE_KEY } from './constants';
...
export function runIndexedDbRequest(request) {
...
export function openProjectHandleDb() {
  return new Promise((resolve, reject) => {
