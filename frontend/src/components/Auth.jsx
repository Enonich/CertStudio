  ...
  return (
    <>
      ...
      <div className="ap-page">
        ...
        {/* ── FORM + LEFT SHOWCASE ── */}
        <div className="ap-center-col">
          {/* Left: typewriter + feature pills */}
          <div className="ap-left-showcase">
            <div className="ap-tw-strip">
              <span className="ap-tw-pre">Issuing certificate to —</span>
              <span className="ap-tw-name">
                {certName}<span className="ap-tw-cursor" />
              </span>
            </div>
            <div className="ap-features">
              <div className="ap-feat-tag">
                <div className="ap-feat-dot" style={{ background: '#d4a84b' }} />
                PDF Export
              </div>
              <div className="ap-feat-tag">
                <div className="ap-feat-dot" style={{ background: '#5b9cf6' }} />
                Bulk Generation
              </div>
              <div className="ap-feat-tag">
                <div className="ap-feat-dot" style={{ background: '#3ecf8e' }} />
                Custom Styling
              </div>
            </div>
          </div>
...
.ap-center-col {
  ...
  gap:48px; position:relative; z-index:10;
}
...
.ap-left-showcase {
  ...
  gap:20px;
  animation:apFadeUp 1s 0.5s both;
  max-width:220px;
}

/* Typewriter demo strip */
.ap-tw-strip {
  display:flex; flex-direction:column; gap:6px;
  font-family:'Lato',sans-serif; font-size:12px;
  color:rgba(255,255,255,0.35); letter-spacing:0.2px;
}
.ap-tw-pre { font-size:10px; letter-spacing:1.5px; text-transform:uppercase; color:rgba(255,255,255,0.2); font-weight:700; }
.ap-tw-name {
  font-family:'Playfair Display',serif; font-style:italic;
  color:rgba(212,168,75,0.8); font-size:18px; min-height:26px;
}
.ap-tw-cursor {
  display:inline-block; width:1.5px; height:13px;
  background:#d4a84b; vertical-align:middle; margin-left:1px;
  animation:apTwBlink 1s step-end infinite;
}
@keyframes apTwBlink { 0%,100%{opacity:1;} 50%{opacity:0;} }

/* Feature pills */
.ap-features {
  display:flex; flex-direction:column; gap:8px;
  animation:apFadeUp 1s 0.7s both;
}
.ap-feat-tag {
  ...
  color:rgba(255,255,255,0.42); letter-spacing:0.2px;
